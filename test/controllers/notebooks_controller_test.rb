...
class NotebooksControllerTest < ActionController::TestCase
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post :create, notebook: { notes_count: @notebook.notes_count, published_at: @notebook.published_at, title: @notebook.title, user_id: @notebook.user_id }
    end
  ...
  test "should update notebook" do
    patch :update, id: @notebook, notebook: { notes_count: @notebook.notes_count, published_at: @notebook.published_at, title: @notebook.title, user_id: @notebook.user_id }
    assert_redirected_to notebook_path(assigns(:notebook))
  end
